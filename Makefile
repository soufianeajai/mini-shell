...
tokenisation/SplitToken.c syntax/syntax.c tokenisation/tokenisation.c tokenisation/util2_token.c tokenisation/utils_token.c \
...
execution/execute_simple_cmd.c execution/util_smp_cmd1.c execution/util_smp_cmd2.c execution/util_tree1.c execution/util_tree2.c mini-shell.c 
OBJS = $(SRCS:.c=.o)
