...
parsing/parsing.c parsing/free_tree.c parsing/parse_redirection.c parsing/expand_env.c parsing/get_arguments.c parsing/parsing_utils.c  execution/execute_tree.c \
...
$(NAME) : $(OBJS)
	cc  -g3 $(CFLAGS)   -o $@ $^ -fsanitize=address -lreadline -L /Users/$(USER)/Desktop/homebrew/opt/readline/lib -I /Users/$(USER)/Desktop/homebrew/opt/readline/include
